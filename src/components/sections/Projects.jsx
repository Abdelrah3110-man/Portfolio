            ...
            {categories.map((category) => (
              <button
                ...
                <div className=" relative flex items-center gap-2">
                  ...
                  {React.createElement(
                    categoryIcons[category] || categoryIcons.all || Target,
                    {
                      className: "w-4 h-4 ",
                    }
                  )}
            ...
            {filteredProjects.length > 3 && (
              <>
                <button
                  ...
                  className="flex absolute left-0 top-1/2 -translate-y-1/2 -translate-x-2 lg:-translate-x-4 justify-center items-center w-10 h-10 lg:w-12 lg:h-12 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full hover:bg-white/20  transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed z-10"
                ...
                <button
                  ...
                  className="flex absolute right-0 top-1/2 -translate-y-1/2 -translate-x-2 lg:-translate-x-4 justify-center items-center w-10 h-10 lg:w-12 lg:h-12 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full hover:bg-white/20  transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed z-10"
