...
const Skills = () => {
  ...
  const skillsCategories = {
    ...
    "Other Skills": [
      ...
      skills.find((skill) => skill.name === "Cyber Security"),
      skills.find((skill) => skill.name === "Java (OOP)"),
  ...
  const getLevelColor = (level) => {
    ...
    return colors[level] || "bg-gray-500  bg-gray-500/20 border-gray-500/30";
  };
                      ...
                      return (
                        <div key={skill.id} className="space-y-2">
                          ...
                          <div className="relative h-1.5 bg-white/5 rounded-full overflow-hidden">
                            <div
                              className=" absolute tpo-0 left-0 h-full bg-linear-to-r from-primary/10 to-primary/80 rounded-full transition-all duration-1000 ease-out"
