...
const Testimonials = () => {
  ...
  const testimonialStars = [
    { value: "3xl", label: "Faster Delivery" },
        ...
        <FadeIn delay={0}>
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-white/60 max-w-xl mx-auto ">
              Empowering client with design-driven, high-quality solutions built
              for success.
            </p>
          </div>
        </FadeIn>
                              ...
                              <div className="bg-black/60 rounded-xl p-4 shadow-lg">
                                <div className="">
                                  <div className=" text-2xl font-semibold text-primary mb-1">
                                    {testimonialStars[index]?.value}
                                  </div>
                                  <div className="text-sm font-semibold text-gray-100 ">
                                    {testimonialStars[index]?.label}
                                  </div>
                                </div>
                              </div>
                            </div>
