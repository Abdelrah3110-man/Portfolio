...
import emailjs from "@emailjs/browser"; // السطر ده مهم جداً!
...
const Contact = () => {
  ...
  const handelSubmit = (e) => {
    ...
    // تصحيح الـ Regex للإيميل (Frankness: تأكدت إنه مضبوط)
    const emailRegex = /^[^\s@]+@[^\s@]+\.[^\s@]+$/;
    if (!emailRegex.test(formData.email)) {
      setStatus({ type: "error", message: "Please enter a valid email" });
      return;
    ...
    // 3. الإرسال باستخدام بياناتك الحقيقية
    emailjs
      .send(
        "service_nhwblw2",
        "template_3o0ock6",
  ...
  return (
    <section id="contact" className=" relative py-20 bg-black overflow-hidden ">
      <div className=" absolute inset-0 overflow-hidden">
        <div className=" absolute top-1/3 left-1/4 w-96 h-96 bg-primary/20 opacity-30  rounded-full blur-3xl" />
        <div className=" absolute bottom-1/4 right-1/4 w-96 h-96 bg-primary/20 opacity-30  rounded-full blur-3xl" />
        <div className=" absolute top-1/2 left-1/2 w-96 h-96 translate-x-1/2 translate-y-1/2 bg-primary/20 opacity-20  rounded-full blur-3xl" />
      </div>
      ...
      <div className=" relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeIn delay={0}>
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl lg:text-5xl font-normal text-white md-4">
              Let's Work Together
            </h2>
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-white/60 leading-relaxed">
                  ...
                  opportunities to be part of vision. Feel free to reach out!
                </p>
              </div>

              <div className="space-y-4">
                <div className="group relative bg-white/5 border border-white/10 hover:border-primary/30 rounded-2xl p-6  transition-all duration-300 ">
                  ...
                  <div className="absolute inset-0 bg-linear-to-br from-primary/0 to-primary/0 group-hover:to-primary/5 group-hover:from-primary/5  rounded-2xl transition-all duration-300  pointer-events-none" />
                </div>
                    ...
                    .map(([platform, url]) => {
                      ...
                      return Icon ? (
                        <a
                          ...
                          className="p-4 bg-white/5 rounded-xl border-white/10 hover:bg-white/10 hover:border-primary/50 hover:scale-110 transition-all duration-300 group">
