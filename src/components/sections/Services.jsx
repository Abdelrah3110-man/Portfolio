      ...
      <div className=" relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeIn delay={0}>
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl lg:text-5xl font-normal text-white mb-4 max-w-2x mx-auto">
          ...
          {services.slice(0, 2).map((service, index) => {
            ...
            return (
              <FadeIn key={service.id} delay={100 + index * 100}>
                <div className="group relative bg-white/5 border border-white/10 hover:border-primary/30 rounded-3xl p-8 flex flex-col transition-all duration-300 h-full min-h-[280px]">
                  <div className="mb-6">
                  ...
                  <div className="absolute inset-0 bg-linear-to-br from-primary/0 to-primary/0 group-hover:to-primary/5 group-hover:from-primary/5  rounded-3xl transition-all duration-300  pointer-events-none" />
                </div>
              </FadeIn>
            );
          })}
          ...
          {services.slice(2).map((service, index) => {
            ...
            return (
              <FadeIn key={service.id} delay={300 + index * 100}>
                <div className="group relative bg-white/5 border border-white/10 hover:border-primary/30 rounded-2xl p-6  transition-all duration-300 h-full ">
                  <div className="mb-4">
