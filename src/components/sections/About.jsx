  ...
  return (
    <section id="about" className=" relative py-20 bg-black overflow-hidden">
      ...
      <div className=" relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Main Grid */}
        <div className=" grid grid-col-1 lg:grid-cols-2 gap-16 items-center mb-20 ">
          {/* left column - Content */}
                ...
                <div className="grid grid-cols-3 gap-8">
                  {ABOUT_STATS.map((stat, index) => (
                    <div key={index} className="relative">
                      ...
                      <div className="text-3xl font-normal text-white font-mono mb-2">
                        {stat.value}
                      </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 w-full max-w-4xl">
              {skills.map((skill, index) => (
                <div
                  ...
                  {/* Hover Glow Effect */}
                  <div className="absolute inset-0 bg-linear-to-br from-primary/0 to-primary-0 group-hover:to-primary/10 group-hover:from-primary/10  rounded-2xl transition-all duration-300"></div>
                </div>
              ))}
            </div>
          </div>
