        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-left">
            ...
            <FadeIn delay={200}>
              <p className="text-lg text-white/70 max-w-[550px] mb-8">
                Building modern, scalable full-stack web applications using the
                MERN stack. I transform complex ideas into exceptional digital
                experiences with clean code and robust architecture.
              </p>
            </FadeIn>
            ...
            <FadeIn delay={300}>
              <button
                ...
                <div className=" relative z-10 bg-white text-[#212121] rounded-[17px] px-[26px] py-[13px] text-base font-medium border border-white hover:bg-white/90 transition-all duration-300">
                  Get in Touch
                </div>
              </button>
            </FadeIn>
          ...
          <FadeIn delay={200}>
            <div className=" relative ">
              <div className=" relative overflow-hidden rounded-2xl aspect-4/5 max-w-[550px] ml-auto group">
