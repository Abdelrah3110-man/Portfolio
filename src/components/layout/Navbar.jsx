...
const Navbar = () => {
  ...
  const activeLink = useScrollSpy(NAV_LINKS.map((link) => link.id));
    ...
    <nav
        ...
        <div className=" flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className=" text-2xl font-bold bg-linear-to-r from-primary/50 to-primary/30 bg-clip-text text-transparent hover:opacity-80 transition-opacity"
              aria-label="home">
      ...
      <div
        ...
        <div className="bg-black/95 backdrop-blur-lg border-t border-white/10 px-5 py-6 space-y-3">
          ...
          <button
            onClick={() => handleNavClick("contact")}
            className="w-full px-7 py-3.5 bg-white  mt-2 text-[#212121] font-medium  text-base rounded-[17px] border border-white hover:bg-white/90 transition-all duration-300">
            Hire Me
          </button>
        </div>
      </div>
