            ...
            <div>
              ...
              <div className=" space-y-3">
                <a
                  ...
                  className="group flex items-center gap-3 p-3  bg-white/5 border border-white/10 hover:border-primary/30 hover:bg-white/10 rounded-xl   transition-all duration-300">
                ...
                {Object.entries(SOCIAL_LINKS).map(([platform, url]) => {
                  ...
                  return Icon ? (
                    <a
                      ...
                      className=" relative p-4 bg-white/5 rounded-xl border-white/10 hover:bg-white/10 hover:border-primary/50 hover:scale-110 transition-all duration-300 group">
